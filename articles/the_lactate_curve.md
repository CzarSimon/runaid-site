...
You know there are thresholds on the curve. This article goes deeper: what those thresholds represent physiologically, why there are two of them, and how the curve maps onto both racing and training. The [previous article](/articles/physiology-of-running-performance) introduced the lactate threshold as one of the key determinants of running performance. Here we unpack the full curve.
