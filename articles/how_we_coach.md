...
Easy runs develop the aerobic base at low fatigue cost. [Threshold sessions](/articles/lactate-curve) shift the lactate curve rightward. [VO₂max intervals](/articles/physiology-of-running-performance) raise the aerobic ceiling. Long runs build durability. [Strength sessions](/articles/strength-and-conditioning) improve running economy and tissue resilience. Each has a clear rationale grounded in the [physiology of performance](/articles/physiology-of-running-performance).
...
- *[The Physiology of Running Performance](/articles/physiology-of-running-performance) — what determines how fast you can run*
- *[The Lactate Curve and What It Means for Your Training](/articles/lactate-curve) — the intensity spectrum*
